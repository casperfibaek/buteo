...
x_train = [
    np.concatenate(
        [
            ...
            np.load(folder + f"{place}/all_noise2_RGBN.npy")[0:100000],
            np.load(folder + f"{place}/extra_building_RGBN.npy"),
        ]
    ),
    np.concatenate(
        [
            np.load(folder + f"{place}/ghana_clean_v2_SAR.npy"),
            np.load(folder + f"{place}/all_noise2_SAR.npy")[0:100000],
            np.load(folder + f"{place}/extra_building_SAR.npy"),
        ]
    ),
    np.concatenate(
        [
            np.load(folder + f"{place}/ghana_clean_v2_RESWIR.npy"),
            np.load(folder + f"{place}/all_noise2_RESWIR.npy")[0:100000],
            np.load(folder + f"{place}/extra_building_RESWIR.npy"),
        ]
    ),
]
...
y_train = np.concatenate(
    [
        ...
        np.load(folder + f"{place}/all_noise2_label_area.npy")[0:100000],
        np.load(folder + f"{place}/extra_building_label_area.npy"),
    ]
)
...
with tf.device("/device:GPU:0"):
    ...
    donor_model_path = outdir + "student2_v3"
