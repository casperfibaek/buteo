...
if __name__ == "__main__":
    ...
    grid_320 = folder + "grid_320m.gpkg"
    grid_160 = folder + "grid_160m.gpkg"
    grid_80 = folder + "grid_80m.gpkg"
    out_folder = folder + "analysis\\"

    b8 = raster_to_array(folder + "b08.tif")
    rgb = raster_to_array(folder + "rgb_b2_b3_b4.vrt")
    blocks = array_to_blocks(rgb, (32, 32, 3))
    

    import pdb; pdb.set_trace()

    # extract_tiles_numpy(folder + "rgb_b2_b3_b4.vrt", grid_320, out_folder, "320_rgb", 32, 32)
    # extract_tiles_numpy(folder + "b08.tif", grid_320, out_folder, "320_nir", 32, 32)
    # extract_tiles_numpy(folder + "coh_asc_desc_mix.vrt", grid_320, out_folder, "320_coh", 32, 32)
    # extract_tiles_numpy(folder + "bs_asc_desc_mix.vrt", grid_320, out_folder, "320_bs", 32, 32)

    # extract_tiles_numpy(folder + "rgb_b2_b3_b4.vrt", grid_160, out_folder, "160_rgb", 16, 16)
    # extract_tiles_numpy(folder + "b08.tif", grid_160, out_folder, "160_nir", 16, 16)
    # extract_tiles_numpy(folder + "coh_asc_desc_mix.vrt", grid_160, out_folder, "160_coh", 16, 16)
    # extract_tiles_numpy(folder + "bs_asc_desc_mix.vrt", grid_160, out_folder, "160_bs", 16, 16)

    # extract_tiles_numpy(folder + "rgb_b2_b3_b4.vrt", grid_80, out_folder, "80_rgb", 8, 8)
    # extract_tiles_numpy(folder + "b08.tif", grid_80, out_folder, "80_nir", 8, 8)
    # extract_tiles_numpy(folder + "coh_asc_desc_mix.vrt", grid_80, out_folder, "80_coh", 8, 8)
    # extract_tiles_numpy(folder + "bs_asc_desc_mix.vrt", grid_80, out_folder, "80_bs", 8, 8)