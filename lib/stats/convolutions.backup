...
cdef Offset_3d * generate_offsets_3d(double [:, :, ::1] kernel, int x_kernel_size, int y_kernel_size, int z_kernel_size, int non_zero) nogil:
    cdef int x, y, z
    ...
    cdef Offset_3d *offsets = <Offset_3d *> malloc(non_zero * sizeof(Offset_3d))
...
cdef void loop_3d(
    ...
    cdef Offset_3d * offsets = generate_offsets_3d(kernel, x_kernel_size, y_kernel_size, z_kernel_size, non_zero)
