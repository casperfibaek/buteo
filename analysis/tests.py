...
from local_statistics import local_statistics, local_statistics2
...
# before2 = time()
# m1 = local_statistics2('E:\\SATF\\data\\surf.tif', radius=1)
# m2 = local_statistics2('E:\\SATF\\data\\surf.tif', radius=2)
# m3 = local_statistics2('E:\\SATF\\data\\surf.tif', radius=3)

# images_array = np.array([m1, m2, m3])
# array_to_raster(np.mean(images_array, axis=0), reference_raster='E:\\SATF\\data\\surf.tif', out_raster='E:\\SATF\\data\\surf_max3.tif')
