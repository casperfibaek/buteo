...
def stats_to_ints(names):
    ...
    for idx, name in enumerate(names):
        ...
        elif name == "var": ints[idx] = 7
        elif name == "variance": ints[idx] = 7
        elif name == "std": ints[idx] = 8
        elif name == "stdev": ints[idx] = 8
        elif name == "standard_deviation": ints[idx] = 8
        elif name == "skew": ints[idx] = 9
        elif name == "kurtosis": ints[idx] = 10
        elif name == "median": ints[idx] = 11
        elif name == "med": ints[idx] = 11
        elif name == "iqr": ints[idx] = 12
        elif name == "q02": ints[idx] = 13
        elif name == "q98": ints[idx] = 14
        elif name == "q1": ints[idx] = 15
        elif name == "q3": ints[idx] = 16
        elif name == "mad": ints[idx] = 17
        elif name == "median_absolute_deviation": ints[idx] = 16
        elif name == "mode": ints[idx] = 18
        elif name == "snr": ints[idx] = 19
        elif name == "eff": ints[idx] = 20
        elif name == "cv": ints[idx] = 21
        else:
