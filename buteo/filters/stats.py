...
def stats_to_ints(names):
    ...
    for idx, name in enumerate(names):
        if name == "count": ints[idx] = 1
        elif name == "range": ints[idx] = 2
        elif name == "min": ints[idx] = 3
        elif name == "max": ints[idx] = 4
        elif name == "sum": ints[idx] = 5
        elif name == "mean": ints[idx] = 6
        elif name == "avg": ints[idx] = 6
        elif name == "average": ints[idx] = 6
        elif name == "var": ints[idx] = 5
        elif name == "variance": ints[idx] = 5
        elif name == "std": ints[idx] = 7
        elif name == "stdev": ints[idx] = 7
        elif name == "standard_deviation": ints[idx] = 7
        elif name == "skew": ints[idx] = 8
        elif name == "kurtosis": ints[idx] = 9
        elif name == "median": ints[idx] = 10
        elif name == "med": ints[idx] = 10
        elif name == "iqr": ints[idx] = 11
        elif name == "q02": ints[idx] = 12
        elif name == "q98": ints[idx] = 13
        elif name == "q1": ints[idx] = 14
        elif name == "q3": ints[idx] = 15
        elif name == "mad": ints[idx] = 16
        elif name == "median_absolute_deviation": ints[idx] = 16
        elif name == "mode": ints[idx] = 17
        elif name == "snr": ints[idx] = 18
        elif name == "eff": ints[idx] = 19
        elif name == "cv": ints[idx] = 20
        else:
...
def calculate_array_stats(arr, stats):
    ...
    for idx in range(stats_length):
        ...
        elif stats[idx] == 11: # iqr
            result[idx] = np.quantile(arr, np.array([0.25, 0.75], dtype="float32")).sum()
        elif stats[idx] == 12: # q02
            result[idx] = np.quantile(arr, 0.02)
        elif stats[idx] == 13: # q92
            result[idx] = np.quantile(arr, 0.98)
        elif stats[idx] == 14: # q1
            result[idx] = np.quantile(arr, 0.25)
        elif stats[idx] == 15: # q3
            result[idx] = np.quantile(arr, 0.75)
        elif stats[idx] == 16: # mad
            median = np.median(arr)
            absdev = np.abs(arr - median)
            result[idx] = np.median(absdev)
        elif stats[idx] == 17: # mode
