...
def _add_border_to_raster(
    ...
    *,
    ...
    ## Kwargs:
    `out_path` (_str_ || _None_): The output path. If **None** the output will be a memory raster.
    `border_size` (_int_): The size of the border.
    `border_size_unit` (_str_): The unit of the border size.
    `border_value` (_int_): The value of the border.
    `overwrite` (_bool_): If **True**, the output raster will be overwritten.
    `creation_options` (_list_ || _None_): Creation options for the output raster.
