...
if __name__ == "__main__":
    ...
    # out_dir = data_folder + "denmark/"
    # # tmp_dir = data_folder + "tmp/"

    # hull = s1 + "denmark_proper_hull.gpkg"

    # s1_images = []
    # # s1_images = glob(s1 + "*_denmark_*.tif")
    # s2_images = glob(s2 + "*20m.tif")
    # # area = data_folder + "area.tif"
    # # volume = data_folder + "volume.tif"
    ...
    # clip_raster(aligned, hull, out_dir, postfix="")
