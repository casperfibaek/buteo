...
if __name__ == "__main__":
    ...
    # s2_tiles = "/home/cfi/Desktop/buteo/geometry/sentinel2_tiles_world.shp"

    # overlap = internal_intersect_vector(s2_tiles, internal_reproject_vector(vector, 4326))
