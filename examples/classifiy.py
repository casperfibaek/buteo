...
df = pd.read_sql_query(f"SELECT DN, mad_mean, mad_min, b8_mean, cxbb_mean, cxbb_min, _ndvi_mean, _ndvi_stdev, _ndvi_max, nl_min, coh_mean, coh_stdev, coh_max, {class_col} FROM 'training_data';", cnx)
...
# model.fit(X_train, y_train, epochs=1000, verbose=1, batch_size=512, callbacks=tensorboard_callback)
