                ...
                for s_tiff in dsm_tiffs:
                    ...
                    for t_tiff in dtm_tiffs:
                        ...
                        if s_tiff_tile == t_tiff_tile:
                            ss = raster_io.raster_to_array(s_tiff)
                            tt = raster_io.raster_to_array(t_tiff)

                            raster_io.array_to_raster(
...
if __name__ == "__main__":
    ...
    meta = raster_io.raster_to_metadata(hot_files[0])
    ...
    for f in hot_files:
        ...
        raster_io.array_to_raster(
            raster_io.raster_to_array(f) * (meta["pixel_width"] * (-meta["pixel_height"])),
