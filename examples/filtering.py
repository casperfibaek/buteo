...
from lib.stats_filters import threshold_filter, median_filter, median_deviation_filter, mad_filter
...
# array_to_raster(median_deviation_filter(raster_to_array(b4_path), width=7), reference_raster=b4_path, out_raster=folder + 'B04_md7.tif')
# array_to_raster(mad_filter(raster_to_array(b4_path), width=7), reference_raster=b4_path, out_raster=folder + 'B04_mad7.tif')
