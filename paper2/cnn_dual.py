...
# X1_raw = np.load(folder + f"{str(int(size))}_bs.npy")[:, :, :, [ml_utils.sar_class("desc")]]
# X1 = ml_utils.scale_to_01(np.clip(X1_raw, 0, 25))
# X2 = np.load(folder + f"{str(int(size))}_coh.npy")[:, :, :, [ml_utils.sar_class("desc")]]
