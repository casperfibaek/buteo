...
# X3 = ml_utils.scale_to_01(np.clip(X1_raw, 0, 25))
# X3_raw = None
...
def create_cnn_model(shape, name):
    ...
    model = Conv2D(64, kernel_size=first_layer_kernel, padding='same', activation='swish', kernel_initializer='he_uniform')(model_input)
